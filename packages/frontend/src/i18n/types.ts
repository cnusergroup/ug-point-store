...
export interface TranslationDict {
  ...
  mall: {
    ...
    outOfStock: string;
    everyone: string;
    travelDomestic: string;
    travelInternational: string;
    travelThreshold: string;
    travelAvailable: string;
    travelAvailableUnit: string;
    travelSpeakerOnly: string;
    travelInsufficientPoints: string;
    travelApply: string;
    travelLoading: string;
    travelSpeakerPoints: string;
    travelSpeakerThreshold: string;
    travelSpeakerInsufficientPoints: string;
  };
  product: {
    loading: string;
    notFound: string;
  ...
  profile: {
    ...
    quickActionMyContent: string;
    quickActionMyTravel: string;
  ...
  settings: {
    ...
    reservationApprovalPoints: string;
    reservationApprovalPointsDesc: string;
    emailSubscriptions: {
      sectionTitle: string;
  ...
  admin: {
    dashboard: {
      ...
      reservationApprovalsTitle: string;
      reservationApprovalsDesc: string;
      reservationPointsConfigTitle: string;
    ...
    settings: {
      title: string;
      backButton: string;
      codeRedemptionLabel: string;
      codeRedemptionDesc: string;
      pointsClaimLabel: string;
      pointsClaimDesc: string;
      adminProductsLabel: string;
      adminProductsDesc: string;
      adminOrdersLabel: string;
      adminOrdersDesc: string;
      loading: string;
      updateSuccess: string;
      updateFailed: string;
      travelSponsorshipLabel: string;
      travelSponsorshipDesc: string;
      travelSponsorshipTitle: string;
      domesticThresholdLabel: string;
      domesticThresholdDesc: string;
      internationalThresholdLabel: string;
      internationalThresholdDesc: string;
      ...
      categoryFeatureToggles: string;
      categoryAdminPermissions: string;
      categoryContentRoles: string;
      categoryEmailNotifications: string;
      categoryTravelSponsorship: string;
      ...
      sectionFeatureTogglesDesc: string;
      sectionAdminPermissionsTitle: string;
      sectionAdminPermissionsDesc: string;
      sectionContentRolesTitle: string;
      sectionContentRolesDesc: string;
      sectionEmailToggleTitle: string;
      sectionEmailToggleDesc: string;
      sectionEmailTemplateTitle: string;
      sectionEmailTemplateDesc: string;
      sectionTravelTitle: string;
      sectionTravelDesc: string;
      sectionInviteExpiryTitle: string;
      sectionInviteExpiryDesc: string;
      sectionTransferTitle: string;
      sectionTransferDesc: string;
      seedTemplateButton: string;
      seedTemplateHint: string;
      seedTemplateSuccess: string;
      seedTemplateFailed: string;
      sectionLeaderboardTitle: string;
      sectionLeaderboardDesc: string;
      leaderboardRankingLabel: string;
      leaderboardRankingDesc: string;
      leaderboardAnnouncementLabel: string;
      leaderboardAnnouncementDesc: string;
      leaderboardUpdateFrequencyLabel: string;
      leaderboardUpdateFrequencyDesc: string;
      frequencyRealtime: string;
    ...
    reports: {
      ...
      noData: string;
      loadMore: string;
      tabPointsDetail: string;
      tabUGActivity: string;
      tabUserRanking: string;
      tabActivitySummary: string;
      ...
      filterType: string;
      filterTypeEarn: string;
      filterTypeSpend: string;
      filterTypeAll: string;
      filterRoleAll: string;
      filterUGAll: string;
      filterActivityAll: string;
      colTime: string;
      colNickname: string;
      colAmount: string;
      colType: string;
      ...
      colUGLCount: string;
      colSpeakerCount: string;
      colVolunteerCount: string;
      exportCSV: string;
      exportExcel: string;
      exporting: string;
      ...
      filterProductTypeCodeExclusive: string;
      filterCategoryId: string;
      filterCategoryAll: string;
      filterStockThreshold: string;
      filterProductStatus: string;
      filterProductStatusAll: string;
      filterProductStatusActive: string;
      filterProductStatusInactive: string;
      filterPeriodType: string;
      filterPeriodTypeMonth: string;
      filterPeriodTypeQuarter: string;
      filterTravelCategory: string;
  ...
  contentHub: {
    ...
    upload: {
      ...
      currentFile: string;
      requiredMark: string;
      statusRejectedNotice: string;
      statusRejectedGenericNotice: string;
      statusPendingNotice: string;
      tagsLabel: string;
    };
    admin: {
      title: string;
  ...
  travel: {
    apply: {
      ...
      communityRoleLabel: string;
      communityRoleHint: string;
      eventLinkLabel: string;
      eventLinkHint: string;
      eventLinkPlaceholder: string;
      eventLinkError: string;
      cfpScreenshotLabel: string;
      cfpUploadHint: string;
      cfpUploadAction: string;
      uploading: string;
      uploadFailed: string;
      transportCostLabel: string;
      flightCostLabel: string;
      flightCostPlaceholder: string;
      hotelCostLabel: string;
      hotelCostPlaceholder: string;
      totalCostLabel: string;
      sectionIdentity: string;
      sectionEvent: string;
      sectionCost: string;
      costSectionHint: string;
      submitButton: string;
      submitting: string;
      submitSuccess: string;
      submitFailed: string;
      ...
      errorCfpRequired: string;
      errorCostRequired: string;
      notice: string;
    };
    myTravel: {
      title: string;
      backButton: string;
      quotaDomestic: string;
      ...
      internationalAvailableLabel: string;
      domesticUsedLabel: string;
      internationalUsedLabel: string;
      filterAll: string;
      filterPending: string;
      filterApproved: string;
      filterRejected: string;
  ...
  batchPoints: {
    page: {
      ...
      submitButton: string;
      confirmTitle: string;
      confirmTargetRole: string;
      confirmSelectedCount: string;
  ...
  activitySync: {
    title: string;
    sectionConfigTitle: string;
    sectionConfigDesc: string;
    syncIntervalLabel: string;
    syncIntervalDesc: string;
    syncIntervalPlaceholder: string;
    feishuUrlLabel: string;
    feishuUrlDesc: string;
    feishuUrlPlaceholder: string;
    feishuAppIdLabel: string;
    feishuAppIdDesc: string;
    feishuAppIdPlaceholder: string;
    feishuAppSecretLabel: string;
    feishuAppSecretDesc: string;
    ...
    sectionActivitiesTitle: string;
    sectionActivitiesDesc: string;
    ...
    websiteSyncLocalOnly: string;
    websiteLastSyncLabel: string;
    websiteNoSources: string;
    websiteUrlValidation: string;
    websiteMaxSources: string;
  };
  activitySelector: {
    title: string;
    hint: string;
  ...
  leaderboard: {
    ...
    nickname: string;
    earnTotal: string;
    updateFrequencyRealtime: string;
