...
// ?????�ʦ�????? Settings_Record ??????????????? getFeatureToggles ?????
...
// ============================================================================
// Property 3: ????????��???????
// Feature: feature-toggle-settings, Property 3: ????????��???????
// ?????��??????��??? codeRedemptionEnabled ?? pointsClaimEnabled ????????
...
// Feature: feature-toggle-settings, Property 6: ??��?????
// ?????��???��?????????????? updateFeatureToggles ��???????????
...
describe('Property 6: ??��??????Round-trip??', () => {
  it(
...
// ?????�ʦ�????????????codeRedemptionEnabled: true/false, pointsClaimEnabled:
...
// ============================================================================
// Property 2: ???????��???????
// Feature: feature-toggle-settings, Property 2: ???????��???????
// ?????��????????????????��???????? SuperAdmin??????1????????????????
...
// ============================================================================
// Property 1 (content-role-settings): getFeatureToggles ?????????????????
// Feature: content-role-settings, Property 1: getFeatureToggles ?????????????????
...
describe('Property 1 (content-role-settings): getFeatureToggles ?????????????????', () => {
...
// ============================================================================
// Property 2 (content-role-settings): adminContentReviewEnabled ��????????
// Feature: content-role-settings, Property 2: adminContentReviewEnabled ��????????
...
describe('Property 2 (content-role-settings): adminContentReviewEnabled ��????????', () => {
...
// ============================================================================
// Property 3 (content-role-settings): contentRolePermissions ��????????
// Feature: content-role-settings, Property 3: contentRolePermissions ��????????
...
describe('Property 3 (content-role-settings): contentRolePermissions ��????????', () => {
...
// ============================================================================
// Property 4 (content-role-settings): contentRolePermissions ?????????
// Feature: content-role-settings, Property 4: contentRolePermissions ?????????
...
describe('Property 4 (content-role-settings): contentRolePermissions ?????????', () => {
